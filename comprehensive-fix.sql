-- Comprehensive Fix for Profiles Table References
-- This script drops ALL functions and recreates them with correct table references
...
-- 4. Recreate the main function with correct references
...
-- 6. Recreate agent_performance_summary view
...
-- 8. Log the comprehensive fix
INSERT INTO audit_log (action, table_name, details)
VALUES (
    'comprehensive_fix_profiles_references',
    'system',
    jsonb_build_object(
        'message', 'Comprehensive fix applied - dropped all functions and recreated with correct user_profiles references',
        'timestamp', NOW()
    )
); 